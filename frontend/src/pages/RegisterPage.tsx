      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[28px] p-8">
          ...
          <div className="mt-6 pt-6 border-t border-[var(--color-border)] text-center">
            <p className="text-[var(--color-muted)] text-sm">Уже есть аккаунт? <Link to="/login" className="tap-link min-w-[44px] justify-center text-[#22c55e] hover:text-[#16a34a] font-semibold">Войти</Link></p>
          </div>
        </div>
      </motion.div>
    </div>
