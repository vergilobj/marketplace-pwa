  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 relative">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden rounded-[34px]">
        <div className="absolute top-0 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-30" style={{ background: 'radial-gradient(circle, #fbfbf8, transparent 70%)' }} />
        <div className="absolute bottom-0 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-30" style={{ background: 'radial-gradient(circle, #a8b0a8, transparent 70%)' }} />
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="glass-card rounded-[34px] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.55)]">
          ...
          <div className="mt-6 pt-6 border-t border-[rgba(255,255,255,0.06)] text-center">
            <p className="text-[var(--color-muted)] text-sm">Нет аккаунта? <Link to="/register" className="text-[#fbfbf8] hover:text-[#e8eae8] font-semibold">Зарегистрироваться</Link></p>
          </div>
        </div>
      </motion.div>
    </div>
