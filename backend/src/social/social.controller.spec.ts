...
describe('SocialController', () => {
  ...
  describe('like', () => {
    it('should like post', async () => {
      ...
      const result = await controller.like({ user: { userId: 'u1' } }, 'post-1');
  ...
  describe('unlike', () => {
    it('should unlike post', async () => {
      ...
      const result = await controller.unlike({ user: { userId: 'u1' } }, 'post-1');
  ...
  describe('addComment', () => {
    it('should add comment', async () => {
      ...
      const result = await controller.addComment({ user: { userId: 'u1' } }, 'post-1', 'Nice!');
  ...
  describe('updateComment', () => {
    it('should update comment', async () => {
      ...
      const result = await controller.updateComment({ user: { userId: 'u1', role: 'BUYER' } }, 'c1', 'Updated');
  ...
  describe('deleteComment', () => {
    it('should delete comment', async () => {
      ...
      const result = await controller.deleteComment({ user: { userId: 'u1', role: 'BUYER' } }, 'c1');
